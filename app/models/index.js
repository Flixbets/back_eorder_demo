...
db.cusproduct = require("../models/cusproduct.model.js")(sequelize, Sequelize);
...
db.people.belongsToMany(db.product,{
  through:{
  model:db.cusproduct,
  as: "product",
  unique: false,
...
db.product.belongsToMany(db.people,{
  through:{
  model:db.cusproduct,
  as: "people",
  unique: false,
...
db.product.hasMany(db.cusproduct,{foreignKey:{name:'productId',allowNull:false},onDelete:'CASCADE'});
db.cusproduct.belongsTo(db.product,{foreignKey:{name:'productId',allowNull:false},onDelete:'CASCADE'});

db.people.hasMany(db.cusproduct,{foreignKey:{name:'peopleId',allowNull:false},onDelete:'CASCADE'});
db.cusproduct.belongsTo(db.people,{foreignKey:{name:'peopleId',allowNull:false},onDelete:'CASCADE'});
